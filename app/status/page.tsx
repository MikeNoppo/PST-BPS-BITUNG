...
// Extract logic that uses useSearchParams into a separate component
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <Suspense fallback={<Card><CardHeader><CardTitle className="text-center text-blue-900">Memuat...</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">Menyiapkan form status.</p></CardContent></Card>}>
            <StatusContent />
          </Suspense>
        </div>
      </div>
